...
| `gpt-oss-20b-q4-low-128k` | 128k | 4096 | — | none | 28.5 | 28.5 | 1961 | — | ✅ |
| `gpt-oss-20b-q4-mid-128k` | 128k | 4096 | — | none | 26.5 | 26.5 | 1961 | — | ✅ |
| `gpt-oss-20b-q4-high-128k` | 128k | 4096 | — | none | 27.3 | 27.3 | 1945 | — | ✅ |
...
- **8k non-think** batch=8192: decode 35.9 t/s, prefill 42 t/s, VRAM 10583 MiB, ~1400% CPU.
- **8k think** batch=8192: decode 36.2 t/s, prefill 47 t/s, VRAM 10583 MiB, ~1500% CPU.
- Batch > ctx is wasteful. VRAM flat regardless of batch. Draft KV (`spec-draft-type-k/v = q4_0`) shrinks but doesn't fix placement.
- **MTP sweep (n_max 1-3, p_min 0.7)**: all variants within ±10-15% noise across n_max values — defaults retained (n_max=2, p_min=0.7).
...
- All variants batch=16384, all fully on GPU (CPU ~100% during decode).
- Decode flat across ctx (compute-bound): 4k=140.7, 8k=130.0, 16k=135.4, 32k=120.4 t/s.
- Prefill scales with prompt: 4k=5382, 8k=5835, 16k=5622, 32k=4374 t/s.
...
- 20B dense. Fits in ~11 GB VRAM. No MTP.
